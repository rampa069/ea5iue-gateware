...
CIC receiver HL2 beta5+ gateware variant with 10 receivers for narrowband use.
...
This is a 10-receiver CIC-only variant with no TX. Fan PWM on DB1-4 is the only actively used data pin; all others are assigned but idle.
...
| 4 | PIN_80 | io_db1_4 | out | Fan PWM | Active |
