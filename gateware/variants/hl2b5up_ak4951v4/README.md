...
HL2 beta5+ gateware variant with AK4951 audio codec (v4) and ATU.
...
The `AK4951=1` macro repurposes DB1 pins for the I2S audio codec interface. The `HL2_ATU_AK4951=1` macro further changes DB1-1 from TX envelope PWM to inverted ATU request, enabling simultaneous AK4951 audio and external ATU support. Fan PWM is disconnected (HL2_FAN=0).
