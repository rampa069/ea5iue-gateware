...
HL2 beta5+ gateware variant with Versa clock bypass enabled.
...
Pin assignments are identical to hl2b5up_main. `HL2_BYPASS_VERSA=1` bypasses the Versa clock internal to the FPGA fabric but does not change any DB1 pin assignments.
