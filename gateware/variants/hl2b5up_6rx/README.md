...
6-receiver HL2 beta5+ gateware variant with minimal features for maximum receiver count.
...
This variant maximizes receiver count (6 RX) by disabling all other features. All DB1 signal pins are assigned but functionally idle except LEDs and I2C.
